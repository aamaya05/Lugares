...
class MainActivity : AppCompatActivity() {
    ...
    //Cliente de autetincacion de google
    ...
    //Este metdo se ejecuta cuando regrese de hacer la autenticacion en google, asincrono
    ...
    //Verifica si el usuario se encuentra autenticado y si es asi pasa a la pantalla principal sin pedir autenticacion
